...
if uploaded_file and analyze_btn:
    ...
    if missing:
        st.info(f"We identified {len(missing)} key skill gaps for the **{selected_role}** role. Follow the resources below to upskill.")
        for s in sorted(missing):
            with st.container():
                ...
                st.markdown("--- ")
    else: st.success("Your profile is a perfect match! Keep maintaining your current skill set.")
